...
| 1:30pm - 3:00pm | Bioinformatics Workshop Stream A:<br>Pei Wang - Imputation and data quality control for proteomics data<br>([description](workshops/workshop_wang.html), [materials](https://bis.amsi.org.au/speakers/pei-wang/)) <br> Bioinformatics Workshop Stream B:<br>Pengyi Yang - Computational analysis for biological discovery from (phospho)proteomic data<br> ([description](workshops/workshop_yang.html), [materials](workshops/PhosR_workshop/index.html)) <br><span style="color:green">**Bioconductor Workshop Stream C:<br>Martin Morgan - R and Bioconductor for Genomic Analysis**<br></span> ([description](workshops/workshop_morgan.html), [materials](https://github.com/Bioconductor/BiocIntro)) | 
