...
| 3:30pm - 4:30pm | <span style="color:green">**Workshop Stream A:<br>Pei Wang - Imputation and data quality control for proteomics data**<br></span> ([description](workshops/workshop_wang.html), [materials]()) <br> <span style="color:green"> **Workshop Stream B:<br>Ben Crossett - Introduction to proteomics**<br></span> ([description](workshops/workshop_crossett_maltby_connolly.html), [materials]()) <br> <span style="color:green">**Workshop Stream C:<br>Peter Hickey & Saskia Freytag - Building a Bioconductor package**<br></span> ([description](workshops/workshop_hickey_freytag.html), [materials]()) |
